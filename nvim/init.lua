...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>sc'] = { name = '[S]earch [C]onfig', _ = 'which_key_ignore' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [C]onfig [N]eovim files' })
      ...
      end, { desc = '[S]earch [C]onfig [H]ypr files' })

      -- Shortcut for searching your Foot configuration files
      vim.keymap.set('n', '<leader>scf', function()
        builtin.find_files { cwd = '~/.config/foot/' }
      end, { desc = '[S]earch [C]onfig [F]oot files' })

      -- Shortcut for searching your Tmux configuration files
      vim.keymap.set('n', '<leader>sct', function()
        builtin.find_files { cwd = '~/.config/tmux/' }
      end, { desc = '[S]earch [C]onfig [T]mux files' })
    end,
  },
